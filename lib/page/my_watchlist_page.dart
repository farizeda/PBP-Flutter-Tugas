...
import 'package:tugas/page/data_budget.dart';
import 'package:tugas/page/form_budget.dart';
import 'package:tugas/model/my_watchlist.dart';
import 'package:tugas/page/detail_watchlist_page.dart';
...
class _MyWatchlistPageState extends State<MyWatchlistPage> {
  Future<List<MyWatchlist>> fetchMyWatchlist() async {
    var url = Uri.parse('https://eda-pbp-tugas-2.herokuapp.com/mywatchlist/json/');
